...
const HeaderBottom = () => {
    ...
    return (
        ...
        <div className={`w-full transition-all duration-300 border-b border-gray-200 ${isSticky ? "fixed top-0 left-0 z-[100] bg-white shadow-lg" : "relative"}`}>
            <div className={`w-[80%] relative m-auto flex items-center ${isSticky ? "py-3" : "py-2"}`}>
                ...
                >
                    <div className='flex items-center gap-2'>
                        ...
                        <span className='text-white font-medium text-sm'>All categories</span>
                    </div>
